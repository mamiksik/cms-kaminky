!function (a) {
    var b = function () {
        ...
        b.settings = {arrows: !0, arrows_constraint: !1, auto_flick: !0, auto_flick_delay: 10, block_text: !0, dot_navigation: !0, dot_alignment: "center", flick_animation: "transition-slide", flick_position: 1, inner_width: !1, theme: "light"}, b.init = function (f, h) {
            ...
            c = a, "transform-slide" == b.settings.flick_animation ? d.find("ul.flicks").attr({style: "-webkit-transform:translate3d(-" + c + "%, 0, 0);-o-transform:translate3d(-" + c + "%, 0, 0);-moz-transform:translate3d(-" + c + "%, 0, 0);transform:translate3d(-" + c + "%, 0, 0)"}) : "transition-slide" == b.settings.flick_animation ? d.find("ul.flicks").attr({style: "left:-" + c + "00%;"}) : "jquery-slide" == b.settings.flick_animation && d.find("ul.flicks").animate({left: "-" + c + "00%"}, function () {
                g = !1
